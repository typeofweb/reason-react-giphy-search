...
function make(text, _) {
  return /* record */[
          ...
          /* didMount */(function (param) {
              console.log(text);
              Curry._1(param[/* send */4], /* FetchingStarted */Block.__(0, [text]));
              return /* NoUpdate */0;
            }),
          /* didUpdate */(function (param) {
              var newSelf = param[/* newSelf */1];
              if (param[/* oldSelf */0][/* state */2][/* text */0] !== newSelf[/* state */2][/* text */0]) {
                Curry._1(newSelf[/* send */4], /* FetchingStarted */Block.__(0, [text]));
              }
              return /* () */0;
            }),
          ...
          /* render */(function (self) {
              var match = self[/* state */2][/* response */2];
              var match$1 = self[/* state */2][/* isFetching */1];
              var exit = 0;
              if (match && !match$1) {
